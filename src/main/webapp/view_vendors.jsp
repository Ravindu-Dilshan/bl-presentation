<%-- 
    Document   : view_vendor
    Created on : Jan 9, 2020, 11:55:01 AM
    Author     : Admins
--%>
                ...
                <div class="maincontent noright">
                    <div class="maincontentinner">
                        <div class="contenttitle radiusbottom0">
                            <h2 class="table"><span>Vendors</span></h2>
                        </div><!--contenttitle-->
                                    ...
                                    if (vv.isEmpty()) {
                                        ...
                                        for (Vendor v : vv) {
                                            out.print("<tr>"
                                                    ...
                                                    + "<td align='center'> <span><a href='manage_vendors.jsp?task=update&vid=" + v.getUserID() + "' target='_blank' "
                                                    + "class='btn btn2 btn_book'><span>Update</span></a></span></td>"
                                                    + "<td align='center'><span><a href='ManageVendors?btnDelete&vid=" + v.getUserID() + "'"
