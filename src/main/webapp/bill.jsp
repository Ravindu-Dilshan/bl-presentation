...
<html>
    ...
    <%String date = "";
        ...
        if (s != null) {
            date = s.getDate();
            itemList = proxy.getAllItems(Integer.parseInt(sid), "sale");
        } else {
            response.sendRedirect("view_sales.jsp");
        }
    %>
    <body>
        ...
        <article>
            <table class="meta">
                <tr>
                    <th><span contenteditable>Sale ID</span></th>
                    <td><span contenteditable><%=sid%></span></td>
                </tr>
                <tr>
