                    ...
                    <div class="maincontent noright">
                                        ...
                                        if (ii.isEmpty()) {
                                            ...
                                            for (Item i : ii) {
                                                ...
                                                out.print("<td class='center'>#" + i.getStock().getStockID() + "</td>"
                                                        ...
                                                        + "<td class='center'>"
                                                        + "<a href='" + i.getStock().getProduct().getImage() + "' target='_blank'>"
                                                        + "<img onerror='if (this.src != \"images/products/a.jpg\") this.src = \"images/products/a.jpg\";'"
                                                        + "width='70' src='" + i.getStock().getProduct().getImage() + "'/></a></td>"
                                                        + "<td class='center'>" + i.getStock().getProduct().getCategory().getName() + "</td>"
                                                        + "<td align='center'><span><a href='AddToCart?btnAddSale&btnRemove&sid=" + i.getStock().getStockID() + "'"
                        ...
                        <br>
                            <div class="contenttitle">
                                <h2 class="form"><span>Payment</span></h2>
                            </div><!--contenttitle-->
                            ...
                            <form id="form2" class="stdform stdform2" method="post" action="ManageSales">
                                ...
                                <p class="stdformbutton">
                                    <button class="submit radius2" name="btnAdd">Finish Sale</button>
                                </p>
                            </form>
                            <br clear="all" />
                            <%if (request.getParameter("serror") != null) {
                                    ...
                                    if (error.equals("empty")) {
                                        ...
                                        out.println("<div class='notification msgsuccess'>"
                                                + "<a class='close'></a><p>Sale Successfully Added"
                                                + "</p></div>");
                                    }
                                }%>
                    </div>
